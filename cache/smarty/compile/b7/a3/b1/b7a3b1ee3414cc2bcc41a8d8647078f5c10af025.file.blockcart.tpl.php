<?php /* Smarty version Smarty-3.1.19, created on 2015-08-03 16:21:12
         compiled from "/Applications/MAMP/htdocs/testguidingyou2/themes/traveler/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:26294384855bf2478ba39b4-00132673%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b7a3b1ee3414cc2bcc41a8d8647078f5c10af025' => 
    array (
      0 => '/Applications/MAMP/htdocs/testguidingyou2/themes/traveler/modules/blockcart/blockcart.tpl',
      1 => 1438586515,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '26294384855bf2478ba39b4-00132673',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55bf24793a13a2_43477167',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55bf24793a13a2_43477167')) {function content_55bf24793a13a2_43477167($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/Applications/MAMP/htdocs/testguidingyou2/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/Applications/MAMP/htdocs/testguidingyou2/tools/smarty/plugins/function.counter.php';
?>
<!-- MODULE Block cart -->
<?php if (isset($_smarty_tpl->tpl_vars['blockcart_top']->value)&&$_smarty_tpl->tpl_vars['blockcart_top']->value) {?>
<div class="col-sm-1 clearfix<?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>" ">
<?php }?>
...
" rel="nofollow">
			...
			<span id="emmpty" class="ajax_cart_no_product<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value>0) {?> unvisible<?php }?>"><?php echo smartyTranslate(array('s'=>'0','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
...
"></span>
				...
				<div class="layer_cart_product_info">
					...
					<div>
						<strong class="dark"><?php echo smartyTranslate(array('s'=>'Booking Date','mod'=>'blockcart'),$_smarty_tpl);?>
</strong>
						<span id="layer_cart_product_arrival"></span>
					</div>
					<div>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				<h2>
					...
					<span class="ajax_cart_product_txt_s <?php if ($_smarty_tpl->tpl_vars['cart_qties']->value<2) {?> unvisible<?php }?>">
						<?php echo smartyTranslate(array('s'=>'There are [1]%d[/1] items in your cart.','mod'=>'blockcart','sprintf'=>array($_smarty_tpl->tpl_vars['cart_qties']->value),'tags'=>array('<span class="ajax_cart_quantity" id="qqty">')),$_smarty_tpl);?>
