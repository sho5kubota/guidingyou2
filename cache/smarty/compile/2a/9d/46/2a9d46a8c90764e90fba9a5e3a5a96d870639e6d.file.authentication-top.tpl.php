<?php /* Smarty version Smarty-3.1.19, created on 2015-08-03 16:21:14
         compiled from "/Applications/MAMP/htdocs/testguidingyou2/themes/traveler/authentication-top.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5662104055bf247aec2bd5-57804587%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a9d46a8c90764e90fba9a5e3a5a96d870639e6d' => 
    array (
      0 => '/Applications/MAMP/htdocs/testguidingyou2/themes/traveler/authentication-top.tpl',
      1 => 1438586515,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5662104055bf247aec2bd5-57804587',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55bf247bb7fc98_10630892',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55bf247bb7fc98_10630892')) {function content_55bf247bb7fc98_10630892($_smarty_tpl) {?>
...
?>
	...
	<div class="row">
<div class="container">
<div class="cclose-auth" style="display:inline-block; cursor:pointer; color:#fff;"><i class="fa fa-times fa-lg"></i></i></div>
...
" method="post" id="create-account_form-top" class="box">
				...
				<div class="form_content clearfix">
					...
					<div class="form-group">
						...
						<input type="text" class="is_required validate account_input form-control auth-input" data-validate="isEmail" id="email_create" name="email_create" value="<?php if (isset($_POST['email_create'])) {?><?php echo stripslashes($_POST['email_create']);?>
<?php }?>" />
					</div>
					<div class="submit">
...
" />
		...
		<div class="col-xs-12 col-sm-6">
			<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('authentication',true), ENT_QUOTES, 'UTF-8', true);?>
" method="post" id="login_form-top" class="box" >
				...
				<div class="form_content clearfix">
					<div class="form-group">
						...
						<input class="is_required validate account_input form-control auth-input" data-validate="isEmail" type="text" id="email" name="email" value="<?php if (isset($_POST['email'])) {?><?php echo stripslashes($_POST['email']);?>
<?php }?>" />
					</div>
					<div class="form-group">
						<label for="passwd"><?php echo smartyTranslate(array('s'=>'Password'),$_smarty_tpl);?>
</label>
						<span><input class="is_required validate account_input form-control auth-input" type="password" data-validate="isPasswd" id="passwd" name="passwd" value="<?php if (isset($_POST['passwd'])) {?><?php echo stripslashes($_POST['passwd']);?>
<?php }?>" /></span>
					</div>
