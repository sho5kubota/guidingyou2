...
class CartControllerCore extends FrontController
{
	...
	public function init()
	{
		...
		$this->arrival = Tools::getValue('arrival');
		// die(print_r($this));
	}
	...
	protected function processChangeProductInCart()
	{
		...
		if (!$this->errors && $mode == 'add')
		{
			...
			{  
				...
				$this->context->cart->updateArrivalDeparture($this->arrival, $this->id_product, $this->id_product_attribute, $this->id_address_delivery);
