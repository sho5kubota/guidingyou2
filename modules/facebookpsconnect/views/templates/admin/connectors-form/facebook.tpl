...
<div class="bootstrap" id="form_connector">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			<label class="control-label col-lg-4"><span class="label-tooltip" data-toggle="tooltip" title data-original-title="{l s='The application permissions asked when the customer is logging in. In most cases, you will want to NOT touch this and leave the default values. But, for developers, you can include if you want a comma-separated list of any of the additional Permissions available on Facebook. In that case, follow this link' mod='facebookpsconnect'} : https://developers.facebook.com/docs/concepts/login/permissions-login-dialog/" href="https://developers.facebook.com/docs/concepts/login/permissions-login-dialog"}><b>{l s='Scope of App permissions' mod='facebookpsconnect'}</b></span> :</label>
			<div class="col-lg-5">
				<input type="text" name="scope" id="scope" value="{if isset($aConnector.data.scope)}{$aConnector.data.scope}{else}user_birthday,user_likes,email,friends_likes,friends_birthday,read_friendlists{/if}" />
			</div>
