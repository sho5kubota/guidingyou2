...
define('_FPC_URL_JS', _MODULE_DIR_ . _FPC_MODULE_SET_NAME . '/js/');

/** defines css URL
 uses => to include css files on templates (use prestashop constant _MODULE_DIR_)  **/
define('_FPC_URL_CSS', _MODULE_DIR_ . _FPC_MODULE_SET_NAME . '/css/');

/** defines admin img URL
 uses => to include js files on templates (use prestashop constant _MODULE_DIR_)  **/
define('_FPC_URL_IMG_ADMIN', _MODULE_DIR_ . _FPC_MODULE_SET_NAME . '/img/admin');
...
define('_FPC_URL_IMG', _MODULE_DIR_ . _FPC_MODULE_SET_NAME . '/'. _FPC_PATH_IMG);
...
define('_FPC_PATH_TPL_NAME', 'views/templates/');
...
/** Hide right column for prestashop 1.6
if (version_compare(_PS_VERSION_,'1.6.0','<')) {
$GLOBALS[_FPC_MODULE_NAME . '_HOOKS']['right']  =  array('name' => ((version_compare(_PS_VERSION_, '1.5.0', '>'))? 'displayRightColumn' : 'rightColumn'), 'data' => Configuration::get(_FPC_MODULE_NAME . '_RIGHT'), 'use' => true, 'title' => '');
}  **/
