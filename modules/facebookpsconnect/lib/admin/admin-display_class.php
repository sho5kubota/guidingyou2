	...
	private function _assign()
	{
		...
		return (
			array(
				...
				'sHeaderInclude'    => BT_FPCModuleTools::getTemplatePath(_FPC_PATH_TPL_NAME . _FPC_TPL_HEADER),
				'sErrorInclude'     => BT_FPCModuleTools::getTemplatePath(_FPC_PATH_TPL_NAME . _FPC_TPL_ERROR),
				'sConfirmInclude'   => BT_FPCModuleTools::getTemplatePath(_FPC_PATH_TPL_NAME . _FPC_TPL_CONFIRM),
