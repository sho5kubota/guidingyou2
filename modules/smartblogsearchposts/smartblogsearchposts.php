...
class smartblogsearchposts extends Module {

     public function __construct() {
            $this->name = 'smartblogsearchposts';
            ...
            $this->displayName = $this->l('SmartBlog Search Posts');
            $this->description = $this->l('Search for smart blogs contents');
     ...
     public function hookLeftColumn($params) {
        ...
        $search_loc = Tools::getValue('search_loc');
        $search_words = Tools::getValue('search_words');
         ...
         if(Module::isInstalled('smartblog') != 1){
                ...
                { 
                           ...
                           $posts =  SmartBlogPost::getSearchPosts($id_lang, $search_loc, $search_words);
                  ...
                  return $this->display(__FILE__, 'views/templates/front/smartblogrecentposts.tpl');
     ...
     public function hookRightColumn($params)
        ...
        public function hookdisplaySearchBlog($params)
            {
                 return $this->hookLeftColumn($params);
            }        
