        ...
        {if isset($view_data) AND !empty($view_data)}
            ...
            {foreach from=$view_data item=post}
                    ...
                    <div id="sds_blog_post" class="col-xs-12 col-sm-4 col-md-3">
                     <div class="news_module_image_holder" style="height:210px;">
                        <span class="news_module_image_holder">
                            <a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}">
                             {if $post.post_img != "no" }
                             
                             <img alt="{$post.title}" class="feat_img_small" src="{$modules_dir}smartblog/images/{$post.id_author}/{$post.post_img}-home-default.jpg" style="max-height:200px">
                             {else}
