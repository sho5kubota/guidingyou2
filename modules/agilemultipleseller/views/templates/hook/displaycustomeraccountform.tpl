...
{*<div id="agile">
  ...
  <div class="checkbox">
	  <input class="seller_account_signup_check" id="seller_account_signup" type="checkbox" name="seller_account_signup" value="1" {if isset($smarty.post.seller_account_signup)}{if $smarty.post.seller_account_signup == 1}checked{/if}{/if}
  ...
  <div class="account_creation agile_account_creation" id="agile_fields" style="display:{if !isset($create_seller_checked)}none;{/if}">
