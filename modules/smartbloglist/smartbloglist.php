...
class smartbloglist extends Module {

    protected  $seller;
    
    /*
    * module: agilemultipleseller
    * date: 2015-05-07 23:01:26
    * version: 3.0.6.2
    */
    ...
    */
    ...
    protected  $id_seller;
     ...
     public function __construct(){
        ...
        $this->displayName = $this->l('SmartBlog Seller List');
        $this->description = $this->l('Blog list for Smart Blog Module');
    ...
    public function hookDisplayBlogSeller() {
        ...
        $view_data['posts'] = SmartBlogPost::GetSellerBlogs(Configuration::get('smartshowhomepost')); 
