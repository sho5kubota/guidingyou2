...
<div class="col-sm-1 clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}" {* style="float:right; *}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			...
			<span id="emmpty" class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}">{l s='0' mod='blockcart'}</span>
		...
		<div class="clearfix">
			<div class="layer_cart_product col-xs-12 col-md-6">
				...
				<div class="layer_cart_product_info">
					...
					<div>
						<strong class="dark">{l s='Booking Date' mod='blockcart'}</strong>
			...
			<div class="layer_cart_cart col-xs-12 col-md-6">
				<h2>
					...
					<span class="ajax_cart_product_txt_s {if $cart_qties < 2} unvisible{/if}">
						{l s='There are [1]%d[/1] items in your cart.' mod='blockcart' sprintf=[$cart_qties] tags=['<span class="ajax_cart_quantity" id="qqty">']}
					</span>
