...
{if !isset($email_create)}
	...
	<div class="row">
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="box wow bounceInLeft" data-wow-duration="1s">
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="box wow bounceInRight" data-wow-duration="1s">
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="std box">
		...
		<div class="account_creation">
			...
			<div class="checkbox">
					...
					<a href="http://guiding-you.co/content/16-guide-legal-notice?content_only=1" class="iframe" rel="nofollow">{l s='(Read the Terms of Service)'}</a>
				</div>
		</div>
		{if $b2b_enable}
			<div class="account_creation">
