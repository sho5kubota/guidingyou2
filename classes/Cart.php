...
class CartCore extends ObjectModel
{
	...
	public function getProducts($refresh = false, $id_product = false, $id_country = null)
	{
		...
		// Build SELECT
		$sql->select('cp.`id_product_attribute`, cp.`id_product`, cp.`quantity` AS cart_quantity, cp.id_shop, cp.arrival, pl.`name`, p.`is_virtual`,
	...
	public function arrivalDate() {
		...
		return Cart::getProductDate($this->id, 'arrival');
	}


	/**
	 *  Return Product Arrival or Departure Date
	 *  $id Cart ID
	 *  $type arrival or departure field
	 *
	 * @return  date (departure or arrival)
	 */
	public static function getProductDate($id, $type) {
	...
	public function updateArrivalDeparture($arrival, $id_product, $id_product_attribute = null, $id_address_delivery = 0) {
